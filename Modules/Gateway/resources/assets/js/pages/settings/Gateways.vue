        ...
        <form @submit.prevent="submit" class="space-y-8 pb-12">
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        <h3
                            class="text-neutral-850 text-sm font-bold tracking-tight dark:text-white"
                        >
                            Stripe Integration
                        </h3>
                        <p class="text-xs text-neutral-500">
                            Accept credit and debit card payments worldwide.
                        </p>
                    </div>
                    <label
                ...
                >
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <p
                            v-if="form.errors['stripe.publishable_key']"
                            class="text-xs font-semibold text-red-500"
                        >
                            {{ form.errors['stripe.publishable_key'] }}
                        </p>
                    </div>
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <p
                            v-if="form.errors['stripe.secret_key']"
                            class="text-xs font-semibold text-red-500"
                        >
                            {{ form.errors['stripe.secret_key'] }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-xs text-neutral-500">
                            Enable local payment gateway for Bangladesh.
                        </p>
                    </div>
                    <label
                        class="relative inline-flex cursor-pointer items-center"
                ...
                >
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <p
                            v-if="form.errors['sslcommerz.store_id']"
                            class="text-xs font-semibold text-red-500"
                        >
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <p
                            v-if="form.errors['sslcommerz.store_password']"
                            class="text-xs font-semibold text-red-500"
                        >
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        />
                        <p
                            v-if="form.errors['sslcommerz.merchant_id']"
                            class="text-xs font-semibold text-red-500"
                        >
                            {{ form.errors['sslcommerz.merchant_id'] }}
                        </p>
                    </div>
                    <div class="flex flex-col gap-2">
                        ...
                        <select
                            ...
                            class="flex h-10 w-full rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm ring-offset-white file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-500 focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-950 dark:ring-offset-neutral-950 dark:placeholder:text-neutral-400 dark:focus-visible:ring-emerald-800"
                        >
                            <option value="live">Live</option>
                            <option value="sandbox">Sandbox</option>
                        </select>
                        <p
                            v-if="form.errors['sslcommerz.mode']"
                            class="text-xs font-semibold text-red-500"
                        >
                            {{ form.errors['sslcommerz.mode'] }}
                        </p>
                    </div>
                </div>
                ...
                <p
                    v-if="form.sslcommerz.enabled"
                    class="border-t border-neutral-100 pt-2 text-xs text-neutral-500 dark:border-neutral-800 dark:text-neutral-400"
                >
                    Checkout currently signs with the server-environment
                    SSLCommerz credentials; values saved here are stored
                    encrypted and take over when config-driven routing ships.
                    IPN endpoint:
                    <code
                        class="rounded bg-neutral-100 px-1 py-0.5 text-[10px] dark:bg-neutral-800"
                        >/payments/sslcommerz/ipn</code
                    >
                </p>
            </div>
            ...
            >
                <div>
                    ...
                    <p class="text-xs text-neutral-500">
                        Choose the format in which payment gateways settings are
                        saved in the system table's value column.
                    </p>
                </div>
                <div class="flex items-center gap-6 pt-2">
                    ...
                    <label class="flex cursor-pointer items-center gap-2">
                        ...
                        <span class="text-sm font-medium"
                            >PHP Serialized (Array) Format</span
                        >
                    </label>
                </div>
                <p
